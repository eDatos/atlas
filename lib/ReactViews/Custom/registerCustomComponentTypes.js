...
const Chart = require("terriajs/lib/ReactViews/Custom/Chart/Chart");
const ChartExpandAndDownloadButtons = require("terriajs/lib/ReactViews/Custom/Chart/ChartExpandAndDownloadButtons");
const Collapsible = require("terriajs/lib/ReactViews/Custom/Collapsible/Collapsible");
const CustomComponents = require("terriajs/lib/ReactViews/Custom/CustomComponents");
const CustomComponentType = require("terriajs/lib/ReactViews/Custom/CustomComponentType");
const TableStructure = require("terriajs/lib/Map/TableStructure");
const VarType = require("terriajs/lib/Map/VarType");
const Icon = require("terriajs/lib/ReactViews/Icon");
const GLYPHS = require("terriajs/lib/ReactViews/Icon").GLYPHS;
...
const registerCustomComponentTypes = function(terria) {
  ...
  function processChartNode(context, node, children) {
    ...
    const title = context.feature.data.properties.ETIQUETA || node.attribs["title"];
