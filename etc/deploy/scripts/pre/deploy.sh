...
scp -o "StrictHostKeyChecking=no" -r etc/deploy/config/pre/* deploy@mgcartera.gobiernodecanarias.net:$ENV_CONF
scp -o "StrictHostKeyChecking=no" -r target/terria-*.jar deploy@mgcartera.gobiernodecanarias.net:$TRANSFER_PATH/terria.jar
